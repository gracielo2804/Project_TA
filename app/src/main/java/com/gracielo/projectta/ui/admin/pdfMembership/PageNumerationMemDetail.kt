...
internal class PageNumerationMemDetail (val createdDate:String): PdfPageEventHelper() {
    override fun onEndPage(writer: PdfWriter, document: Document) {
        try {
            ...
            //2nd Column
            cell = PdfPCell(Phrase("Page - " + writer.pageNumber+1.toString(), FONT_FOOTER))
    ...
    companion object {
        private val TAG = PageNumerationMemDetail::class.java.simpleName
