...
internal object PDFUtilityNutrientHistory {
    private val TAG = PDFUtilityNutrientHistory::class.java.simpleName
...
//        document.addHeader("DEVELOPER", "RAVEESH G S")
    ...
    private fun addHeader(mContext: Context, document: Document) {
        ...
        run {
            ...
            temp = Paragraph("Nutrition History Report", FONT_SUBTITLE)
            temp.alignment = Element.ALIGN_CENTER
            cell.addElement(temp)
...
//            logoTable.addCell(logoCell)
    ...
    private fun createDataTable(dataTable: List<Array<String>>): PdfPTable {
        ...
        table1.setWidths(floatArrayOf(1f,2f,2f))
        table1.headerRows = 1
        ...
        run {
            ...
            cell = PdfPCell(Phrase("Max Limit", FONT_COLUMN))
            cell.horizontalAlignment = Element.ALIGN_CENTER
            cell.verticalAlignment = Element.ALIGN_MIDDLE
            cell.setPadding(4f)
            table1.addCell(cell)

            cell = PdfPCell(Phrase("Consumption", FONT_COLUMN))
            cell.horizontalAlignment = Element.ALIGN_CENTER
            cell.verticalAlignment = Element.ALIGN_MIDDLE
            cell.setPadding(4f)
            table1.addCell(cell)
