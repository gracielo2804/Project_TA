...
class FastScrollerJ extends LinearLayout {
    ...
    public FastScrollerJ(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialise(context);
    }

    public FastScrollerJ(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initialise(context);
    }

    public FastScrollerJ(Context context) {
        super(context);
    }
