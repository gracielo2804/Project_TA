...
abstract class NetworkBoundResourceTwo<ResultType, RequestType>
@MainThread constructor(private val mExecutors: AppExecutors) {
    ...
    @WorkerThread
    protected open fun processResponse(response: ApiResponses.Success<RequestType>) = response.data
